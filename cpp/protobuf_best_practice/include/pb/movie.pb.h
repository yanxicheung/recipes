...
inline ::movie::MovieInfoRequest* Message::_internal_mutable_movie_info_request() {
  if (!_internal_has_movie_info_request()) {
    ...
    Messages_.movie_info_request_ = CreateMaybeMessage< ::movie::MovieInfoRequest >(
        GetArenaNoVirtual());
  }
...
inline ::movie::MovieInfoResponse* Message::_internal_mutable_movie_info_response() {
  if (!_internal_has_movie_info_response()) {
    ...
    Messages_.movie_info_response_ = CreateMaybeMessage< ::movie::MovieInfoResponse >(
        GetArenaNoVirtual());
  }
...
inline void Score::set_comment(const char* value, size_t size) {
...
inline void MovieInfoRequest::set_name(const char* value, size_t size) {
...
inline void MovieInfoResponse::set_name(const char* value, size_t size) {
...
inline ::movie::BasicInfo* MovieInfoResponse::_internal_mutable_basic_info() {
  ...
  if (basic_info_ == nullptr) {
    auto* p = CreateMaybeMessage<::movie::BasicInfo>(GetArenaNoVirtual());
    basic_info_ = p;
  }
  return basic_info_;
}
